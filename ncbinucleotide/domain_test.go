...
// HTTP behaviour is covered in ncbinucleotide_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "ncbinucleotide://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ncbinucleotide", "about")
	if err != nil || got.String() != "ncbinucleotide://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ncbinucleotide://page/about", got.String(), err)
	}
}
