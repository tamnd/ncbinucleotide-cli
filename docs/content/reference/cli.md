...
```
ncbinucleotide <command> [arguments] [flags]
```

Run `ncbinucleotide <command> --help` for the full flag list on any command. This
...
per operation you declare in `ncbinucleotide/domain.go`.
