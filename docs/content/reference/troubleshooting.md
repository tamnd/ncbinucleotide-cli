...
Most of these come down to network reality or how ncbinucleotide serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ncbinucleotide rate-limits like any public site. ncbinucleotide already paces
...
Where a surface is gated, ncbinucleotide reads a cookie or token you supply
...
`ncbinucleotide`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ncbinucleotide actually did
